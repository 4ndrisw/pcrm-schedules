...
//$schedules_show_clients_schedule_button = get_option('schedules_show_clients_schedule_button');
//$schedules_tab_on_clients_page = get_option('schedules_tab_on_clients_page');
//$schedules_show_summary = get_option('schedules_show_summary');
?>
...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="general">
      ...
      <hr />
      <?php render_yes_no_option('show_sale_agent_on_schedules','settings_show_sale_agent_on_schedules'); ?>
      <hr />
      ...
      <?php echo render_textarea('settings[predefined_terms_schedule]','settings_predefined_predefined_term',get_option('predefined_terms_schedule'),array('rows'=>6)); ?>
        ...
        <div class="mtop10">
            <span class="label label-info"><strong><?= get_schedules_version(); ?></strong></span>
        </div>
    </div>
</div>